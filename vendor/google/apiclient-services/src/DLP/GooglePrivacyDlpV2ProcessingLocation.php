...
class GooglePrivacyDlpV2ProcessingLocation extends \Google\Model
{
  ...
  /**
   * @param GooglePrivacyDlpV2DocumentFallbackLocation
   */
  ...
  {
    return $this->imageFallbackLocation;
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(GooglePrivacyDlpV2ProcessingLocation::class, 'Google_Service_DLP_GooglePrivacyDlpV2ProcessingLocation');
