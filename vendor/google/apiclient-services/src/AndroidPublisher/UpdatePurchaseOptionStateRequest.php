...
class UpdatePurchaseOptionStateRequest extends \Google\Model
{
  ...
  {
    return $this->deactivatePurchaseOptionRequest;
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(UpdatePurchaseOptionStateRequest::class, 'Google_Service_AndroidPublisher_UpdatePurchaseOptionStateRequest');
