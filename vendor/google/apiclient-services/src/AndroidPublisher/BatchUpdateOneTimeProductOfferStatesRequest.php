...
class BatchUpdateOneTimeProductOfferStatesRequest extends \Google\Collection
{
  ...
  /**
   * @param UpdateOneTimeProductOfferStateRequest[]
   */
...
class_alias(BatchUpdateOneTimeProductOfferStatesRequest::class, 'Google_Service_AndroidPublisher_BatchUpdateOneTimeProductOfferStatesRequest');
