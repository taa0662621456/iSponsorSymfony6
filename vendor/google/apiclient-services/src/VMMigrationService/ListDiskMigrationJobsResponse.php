...
class ListDiskMigrationJobsResponse extends \Google\Collection
{
  ...
  {
    $this->diskMigrationJobs = $diskMigrationJobs;
  }
  /**
...
class_alias(ListDiskMigrationJobsResponse::class, 'Google_Service_VMMigrationService_ListDiskMigrationJobsResponse');
