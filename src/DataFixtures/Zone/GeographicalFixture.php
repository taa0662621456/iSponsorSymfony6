...
final class GeographicalFixture extends AbstractDataFixture
{
    ...
    public function load(ObjectManager $options): void
    {
        $this->loadCountriesWithProvinces($options['countries'], $options['provinces']);
        $this->loadZones($options['zones'], $this->provideZoneValidator((array) $options));
