...
class RedirectToPreferredLocaleSubscriber implements EventSubscriberInterface
{
    public function __construct(private readonly UrlGeneratorInterface $urlGenerator,
                                private readonly string $locales, private string $locale)
    {
        ...
        if (!in_array($this->locale, $locales, true)) {
            throw new UnexpectedValueException(sprintf('The default locale ("%s") must be one of "%s".', $this->locale, $locales));
        }
