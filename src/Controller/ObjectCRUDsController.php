...
class ObjectCRUDsController extends AbstractController
{
    ...
    #[Route(path: 'vendor/shipment/edit/{id<\d+>}', name: 'vendor_edit_id_shipment', methods: ['GET', 'POST'])]
    ...
    #[Route(path: 'review/product/edit/{slug}', name: 'review_edit_slug_product', methods: ['GET', 'POST'])]
