 ...
 * Этот код сейчас стал часто повторяться в конструкторах классов
 * этот клас можно наполнить статическими членами или
 * проститать небходимость создания объекта (нужно или не нужно, не знаю пока)
 *
 */
