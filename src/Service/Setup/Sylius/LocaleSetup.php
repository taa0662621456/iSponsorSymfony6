...
use App\Interface\LocaleFactoryInterface;
use App\Interface\LocaleInterface;
use App\Interface\LocaleRepositoryInterface;
...
final class LocaleSetup implements LocaleSetupInterface
{
    ...
    public function __construct(private readonly LocaleRepositoryInterface $localeRepository,
                                private readonly LocaleFactoryInterface    $localeFactory,
                                string                               $locale)
    {
